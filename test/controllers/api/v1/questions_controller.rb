...
class Api::V1::QuestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_list_all_questions
    ...
    first_question = response_body.first

    expected_keys = %w[id content position quiz_id created_at updated_at]
  ...
  def test_create_question
    ...
    assert_difference "Question.count", 1 do
      post api_v1_quiz_questions_url(@quiz),
        params: payload,
        headers: @headers
    end

    assert_response :created
    assert_equal "What is Ruby?", response_body["content"]
  end
  ...
  def test_update_question
    ...
    patch api_v1_quiz_question_url(@quiz, @question),
      params: payload,
      headers: @headers

    assert_response :ok
    assert_equal "Updated content", @question.reload.content
  end
